<%@ Page Title="" Language="C#" MasterPageFile="~/Layouts/ShopHeader.Master" AutoEventWireup="true" CodeBehind="CreateProduct.aspx.cs" Inherits="Pattern_Software_Design_Qualification.Views.CreateProduct" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="max-width: 425px; margin: auto;" class="border rounded p-4 mt-4 d-flex flex-column">
        ...
        <br />
        <asp:LinkButton ID="CreateButton" runat="server" CssClass="btn btn-success" OnClick="CreateButton_Click">Create</asp:LinkButton>
    </div>
    <br />
</asp:Content>
